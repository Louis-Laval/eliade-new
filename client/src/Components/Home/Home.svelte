<script>
  ...
  import * as offerService from "../../Business/offerService";
...
<Banner />
<Sections section="company" heading="Notre entreprise"  backgroundColor="light-color" sectionList={companyService.getCompany()}/>
...
<Sections section="offers" heading="Nos offres" backgroundColor="light-color" sectionList={offerService.getOffers()}/>
